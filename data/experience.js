export const experience = [
  ...
  },
  {
    ...
    image: '/img/logos/usj_square.webp',
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        text: ['Mentored interns by defining their project scopes, setting clear objectives, and providing continuous guidance and constructive feedback.'],
        skills: ['Mentorship', 'Project Planning', 'Performance Feedback', 'Communication'],
      },
      {
        title: 'Career Development & Certifications',
        text: ['Worked on my career development by learning new skills, expanding my knowledge, and participating in professional development programs.'],
