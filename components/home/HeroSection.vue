    ...
    <section id="hero">
        <div class="wrap hero-inner">
            <div class="hero-copy">
                ...
                <p class="eyebrow hero-eyebrow">Full-stack &amp; AI engineer</p>

                <h1 class="hero-name">Chris Rahmé</h1>

                <p class="lead">I build full-stack apps, with expertise in AI</p>
...
#hero {
    ...
    color: var(--star);
    background:
        radial-gradient(60% 45% at 50% 100%, rgba(201, 112, 92, 0.35) 0%, rgba(201, 112, 92, 0) 100%),
