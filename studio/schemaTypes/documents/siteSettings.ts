  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'heroEyebrow', title: 'Hero eyebrow', description: 'Small line above the name.', type: 'internationalizedArrayString' }),
        defineField({ name: 'heroTitle', title: 'Hero title', type: 'string' }),
        defineField({ name: 'heroLead', title: 'Hero lead', description: 'One sentence under the name.', type: 'internationalizedArrayString' }),
        defineField({
          name: 'aboutGreeting',
    ...
    defineField({
      ...
      fields: [
        defineField({ name: 'description', title: 'Meta description', type: 'internationalizedArrayText' }),
        defineField({ name: 'eyebrow', title: 'Eyebrow', description: 'Small line above the name, e.g. the job title.', type: 'internationalizedArrayString' }),
        defineField({ name: 'title', title: 'Title', description: 'Usually the full name.', type: 'string' }),
        defineField({ name: 'summary', title: 'Summary', description: 'Intro paragraphs at the top of the resume.', type: 'internationalizedArrayRichText' }),
    ...
    defineField({
      ...
      fields: [
        defineField({ name: 'description', title: 'Meta description', type: 'internationalizedArrayText' }),
        defineField({ name: 'lead', title: 'Lead', description: 'One sentence under the page title.', type: 'internationalizedArrayString' }),
      ],
    }),
    defineField({
      name: 'footer',
